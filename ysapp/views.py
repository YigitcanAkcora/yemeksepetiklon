...
class MahalleListView(ListView):
    model = MahalleYemek
    template_name = 'ysapp/mahalle_view.html'
    context_object_name = 'mahalle'
    ordering = ['yemekadi']

class MahalleAddView(LoginRequiredMixin ,CreateView):
    model = MahalleYemek
    form_class = MahalleForm
    template_name = 'ysapp/mahalle_add.html'
    success_url = reverse_lazy('ysapp:mahalle')